    ...
    <body>
        ...
        <section>
            ...
            <div>
                <h2>Abilities</h2>
                <p>
                    Administrators have the ability to register new users, create new sessions, assign default picks to certain games each session, and view the results before they are sent out to the players. Administrators set up the weekly sessions and make sure the website runs smoothly.
                </p>
            </div>
            ...
            <div>
                ...
                <p>
                    The Pick 5 website only allows picks to be made by registered users. Users may only be registered once their email is in the system, added by administrators. From there, users register using that same email and set their display name and password under the "registration" page. Once registered, users may make picks.
            ...
            <div>
                ...
                <p>
                    ...
                    If a game result is entered incorrectly, re-enter the game for the session and then re-send the results out. This forces the calculations to be done again. Calculations for previous weeks are not affected.
                </p>
            </div>
            ...
            <div>
                ...
                <p>
                    Each week, before the final results go out, administrators must review the results and okay them. If there is an issue, minor fixes may be made (such as adjusting who covered the spread and the default underdogs). For major changes or bugs, contact Cayden Codel (email: crcodel@mchsi.com).
                </p>
            </div>
