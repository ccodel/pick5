    ...
    <body>
        ...
        <section>
            ...
            <form id="session-create-form" action="../../php/submit/submit-session.php" method="post">
                ...
                <div>
                    <h4>Choose if you would like to automatically generate games.<br>
                        Clicking the "Find games" button will attempt to fill the games in automaticallly.<br>
                        Clicking the "Enter games" button will set up a blank table.</h4>
                    <button type="button" id="find-games">Find games</button>
